...
export const MISSION_CARD_STYLES = {
   ...
   DESCRIPTION: 'text-sm font-light tracking-wider text-slate-500 leading-loose mt-5 text-center group-hover:text-white ease-in-out duration-200',
};
...
export const CAUSE_CARD_STYLES = {
   ...
   TITLE: 'text-xl text-blue-950 font-semibold capitalize tracking-wide mb-3.5 hover:text-emerald-500 cursor-pointer ease-in-out duration-200',
   SUB_TITLE: 'text-xs text-emerald-500 font-normal capitalize tracking-wide mb-1.5',
