...
export enum MISSION_CARD_STYLES {
...
export enum CAUSE_CARD_STYLES {
   MAIN = 'group bg-white rounded-md light-shadow w-full ease-in-out duration-300 overflow-hidden',
   BODY = 'px-5 py-6 w-full h-min',
   TITLE = 'text-xl text-blue-950 font-semibold capitalize tracking-wide hover:text-emerald-500 cursor-pointer ease-in-out duration-200',
