...
export const CAUSE_CARD_STYLES = {
   ...
   TITLE: 'text-xl text-blue-950 font-semibold capitalize tracking-wide mb-3 hover:text-emerald-500 cursor-pointer ease-in-out duration-200',
   SUB_TITLE: 'text-sm text-slate-400 font-light capitalize tracking-wide mb-10',
