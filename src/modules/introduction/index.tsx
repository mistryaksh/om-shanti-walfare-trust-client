...
export const IntroductionModule: FC = () => {
   ...
   return (
      <div className="flex flex-col items-center justify-center w-full">
         <div className="flex flex-col items-center justify-center w-full">
            <p className="text-emerald-500 text-2xl font-medium tracking-wider mb-2.5">Who Are We</p>
            <div className="bg-emerald-500 h-0.5 w-24 mb-6" />
            <div className="flex flex-col items-center justify-center mb-14">
               <img src="/images/intro.jpg" alt="introduction-img" className="aspect-video w-full rounded" />
            </div>
            <h1 className="text-blue-950 text-3xl font-semibold tracking-wide leading-normal mb-10 text-center">
         ...
         <div className="w-3/4 mb-16">
            <p className="text-slate-500 text-lg font-normal tracking-wider mb-6 text-center">
         ...
         <div className="w-3/4 mb-8">
            <p className="text-emerald-500 text-2xl font-medium tracking-wider mb-2.5 text-center">Vision</p>
            <div className="flex flex-col items-center justify-center w-full">
               <div className="bg-emerald-500 h-0.5 w-12 mb-6" />
            </div>
            <p className="text-slate-500 text-base font-normal tracking-wider mb-6 text-center">
               We envision making a significant to quality education and environment.
            </p>
         </div>

         <div className="w-3/4 mb-8">
            <p className="text-emerald-500 text-2xl font-medium tracking-wider mb-2.5 text-center">Mission</p>
            <div className="flex flex-col items-center justify-center w-full">
               <div className="bg-emerald-500 h-0.5 w-16 mb-6" />
            </div>
            <p className="text-slate-500 text-base font-normal tracking-wider mb-6 text-center">
         ...
         <div className="w-3/4">
            <p className="text-emerald-500 text-2xl font-medium tracking-wider mb-2.5 text-center">Beneficiary Groups</p>
            <div className="flex flex-col items-center justify-center w-full">
               <div className="bg-emerald-500 h-0.5 w-40 mb-6" />
            </div>
            <p className="text-slate-500 text-base font-normal tracking-wider mb-6 text-center">
